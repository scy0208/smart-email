const stats = [
    { id: 1, name: 'Customer support workload reduction', value: '37%' },
    { id: 2, name: 'New employee training time reduction', value: '72%' },
    { id: 3, name: 'Customer Satisfied CSAT increasing', value: '33%' },
  ]
        ...
        <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-xl">
            ...
            <p className="mt-2 text-3xl font-bold tracking-tight text-white sm:text-4xl">
              Trusted by e-commerce and small businesses
            </p>
            <p className="mt-6 text-lg leading-8 text-gray-300">
              Maximize your customer service efficiency and minimize your customer service training difficulty
            </p>
          </div>
          <dl className="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-10 text-white sm:mt-20 sm:grid-cols-2 sm:gap-y-16 lg:mx-0 lg:max-w-none lg:grid-cols-4">
            {stats.map((stat) => (
              <div key={stat.id} className="flex flex-col gap-y-3 border-l border-white/10 pl-6">
                <dt className="text-md leading-6 font-bold">{stat.name}</dt>
                <dd className="order-first text-3xl font-bold tracking-tight">{stat.value}</dd>
              </div>
            ))}
          </dl>
        </div>
